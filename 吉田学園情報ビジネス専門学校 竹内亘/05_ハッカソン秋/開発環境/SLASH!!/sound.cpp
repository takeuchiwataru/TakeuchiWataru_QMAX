...
SOUNDPARAM g_aSoundParam[SOUND_LABEL_MAX] =
{
	...
	{ "data/BGM/result.wav", -1 },		// ゲームBGM
	{"data/BGM/ranking.wav", -1 },		// ランキングBGM
	{"data/SE/zangeki.wav", 0},			// 斬撃音
	{"data/SE/zankikaihuku.wav", 0},	// 残機回復
	{"data/SE/lifekaihuku.wav", 0},		// ライフ回復
	{"data/SE/kenma.wav", 0},			// 研磨
	{"data/SE/ken.wav", 0},				// 剣リロード
	{"data/SE/kaminari.wav", 0},		// 必殺
	{"data/SE/bomb000.wav", 0 }	,		// 敵爆発
	{ "data/SE/decide000.wav", 0 },		// 決定音
    { "data/SE/select000.wav", 0 }		// 決定音
};
