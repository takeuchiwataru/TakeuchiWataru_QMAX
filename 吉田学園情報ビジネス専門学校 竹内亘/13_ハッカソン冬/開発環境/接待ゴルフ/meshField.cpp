...
//静的メンバ変数宣言
//--------------------------------------------
//LPDIRECT3DVERTEXBUFFER9		CSceneMeshField::m_pVtxBuff = NULL;

//グローバル
//float g_aHeght[10000][10000] = {0};
...
void  CSceneMeshField::Update(void)
{
	...
	//}
	////ファイルをロード
	//if (pInput->GetPress(DIK_BACKSPACE) == true)
	//{
	//	LoadHeight();
	//}
...
// セーブ処理
//=============================================================================
void CSceneMeshField::SaveHeight(void)
{
	// 頂点情報の設定
	//VERTEX_3D *pVtx;
	//// 頂点バッファをロックし、頂点データへのポインタを取得
...
// ロード処理
//=============================================================================
void CSceneMeshField::LoadHeight(void)
{
	//// 頂点情報の設定
	//VERTEX_3D *pVtx;
	//// 頂点バッファをロックし、頂点データへのポインタを取得
	...
	//if (pFile != NULL)
	//{	//ファイル読み込み
	//	fread(&g_aHeght[0][0], sizeof(float), m_nSplitX * m_nSplitZ, pFile);
	//}
	//else
	//{	//ファイルが開けなかった
	//	printf("ファイルが開けませんでした\n");
...
// 頂点取得処理
//=============================================================================
//LPDIRECT3DVERTEXBUFFER9 CSceneMeshField::GetVtx(void)
//{
//	return m_pVtxBuff;
//}
		...
		for (int nCntX = 0; nCntX < m_nSplitX + 1; nCntX++)
		{
			...
			{//下
				...
				{	//中 頂点が3重なる
					...
					///test = (m_nSplitX * 2) * (m_nSplitZ - 1) + ((nCntX - 1) * 2);
					//test2 = (m_nSplitX * 2) * (m_nSplitZ - 1) + ((nCntX - 1) * 2) + 1;
					//test3 = (m_nSplitX * 2) * (m_nSplitZ - 1) + ((nCntX - 1) * 2) + 2;
				}
				else if (nCntX == m_nSplitX)
				{	//右端
...
// メッシュフィールドの大きさ変更処理
//=============================================================================
void CSceneMeshField::SetWidthDepth(float fWidth, float fDepth)
{
	m_fDepth = fDepth;
	m_fWidth = fWidth;
...
// メッシュフィールドの色変更処理
//=============================================================================
void CSceneMeshField::SetColor(D3DXCOLOR col)
{
	// 頂点情報の設定
	VERTEX_3D *pVtx;	// 頂点情報へのポインタ
