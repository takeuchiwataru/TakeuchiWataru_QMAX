...
//プレイヤークラスの定義
//*********************************************************************
class CSyatyou : public CScene //派生クラス
{
public:
	//キー要素
	typedef struct
	...
	typedef enum
	{
		SYATYOUSTATE_NONE = 0,		//初期状態
		SYATYOUSTATE_NORMAL,			//通常
		SYATYOUSTATE_SWING,			//振る
		SYATYOUSTATE_MAX,			//最大数
	}SYATYOUSTATE;
	...
	static CSyatyou *Create(D3DXVECTOR3 pos, float fLength);
...
private:
	...
	static SYATYOUSTATE			m_State;				//プレイヤーの状態
