...
HRESULT CMeshOrbit::Init(void)
{
	...
	m_offSet[1] = D3DXVECTOR3(0.0f, 10.0f, 0.0f);
...
void  CMeshOrbit::Update(void)
{
	...
	{
		// 頂点カラーの設定
		//pVtx[nCntVtxX + nVtxCounter].col =		D3DXCOLOR(1.0f, 0.0f, 0.0f, m_fAlpha - (m_nAlphaMinus * 0.001f * (nCntVtxX + 1)));
		//pVtx[nCntVtxX + nVtxCounter + 1].col =	D3DXCOLOR(1.0f, 0.0f, 0.0f, 0.7f - (m_nAlphaMinus * 0.001f * (nCntVtxX + 1)));
		pVtx[nCntVtxX + nVtxCounter].col =		D3DXCOLOR(1.0f, 1.0f, 1.0f, m_fAlpha - (nCntVtxX * 0.03f));
		pVtx[nCntVtxX + nVtxCounter + 1].col =	D3DXCOLOR(1.0f, 1.0f, 1.0f, m_fAlpha - (nCntVtxX * 0.01f));
