...
// マクロ定義
//*****************************************************************************
#define TEXTURE_NAME1        "data/TEXTURE/pause200.png" // 読み込むテクスチャ名(CONTINUE)
#define TEXTURE_NAME2        "data/TEXTURE/pause101.png" // 読み込むテクスチャ名(RETRY)
#define TEXTURE_NAME3        "data/TEXTURE/pause102.png" // 読み込むテクスチャ名(QUIT)
